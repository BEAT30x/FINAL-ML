...
if image_model is None or video_model is None:
    ...
    # ----------------------------------------------------------------
    # TAB 3: LIVE STREAM CAMERA (ABJAD) - BROWSER
    # ----------------------------------------------------------------
    with tab3:
        ...
        with c2:
            ...
            if 'abjad_result' in st.session_state:
                ...
                st.info("📷 Klik Start Camera, lalu Capture untuk prediksi")

    # ----------------------------------------------------------------
    # TAB 4: LIVE STREAM CAMERA (KATA) - BROWSER
    # ----------------------------------------------------------------
    with tab4:
        ...
        c1, c2 = st.columns([2, 1], gap="medium")
        with c1:
            st.components.v1.html(camera_kata_html(), height=550)
        with c2:
