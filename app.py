...
if image_model is None or video_model is None:
    st.error("🚨 Master Model File (`.h5` / `.pkl`) tidak ditemukan di folder `models/` atau ROOT folder.")
else:
    ...
    # ----------------------------------------------------------------
    # TAB 3: LIVE STREAM CAMERA (ABJAD) - SEPERTI KODE LOKAL ANDA
    # ----------------------------------------------------------------
    with tab3:
    ...
    # ----------------------------------------------------------------
    # TAB 4: LIVE STREAM CAMERA (KATA) - SEPERTI KODE LOKAL ANDA
    # ----------------------------------------------------------------
    with tab4:
